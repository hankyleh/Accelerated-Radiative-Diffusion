...
The multigroup equation for the error of the $(l+1/2)$th iterate of \autoref{eq:iterative_neutron} is

\begin{equation}
  -\nabla \cdot D_k\nabla \epsilon_k^{l+1/2} + \left(\sigma_a + \sigma_{f, k}\right)\epsilon_k^{l+1/2} = \eta \chi_k \sum_{g=1}^{N_g} \sigma_{f, g} \left[ \epsilon_g^l + I_g^{l-1} \right]; \; k=1, 2,\dots, N_g
\end{equation}
