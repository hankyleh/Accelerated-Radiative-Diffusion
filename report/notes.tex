...
In the left boundary cell, using \autoref{eq:left-boundary}, we have
...
\begin{subequations}
  ...
  \begin{multline}
    ...
    +\left[ \frac{1}{2}D_k \left(  I_{L, 1}^{n+1}\right)  + \frac{1}{2}D_k \left(I_{L, 1}^{n+1} + I_{R, 1} ^{n+1}\right)\right]=E^{in, +, n},
  \end{multline}
\end{subequations}
...
\begin{subequations}\label{eq:right-equations}
  ...
  \begin{multline}
    ...
    +\left[\frac{1}{2}D_k \left( I_{R, {N_x}-1}^{n+1} \right)  - \frac{1}{2}D_k \left(I_{L, {N_x}}^{n+1} + I_{R, {N_x}} ^{n+1}\right)\right]= -E^{in, -, n}.
  \end{multline}
\end{subequations}
